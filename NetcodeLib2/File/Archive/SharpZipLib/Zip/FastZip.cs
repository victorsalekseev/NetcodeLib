...
using System;
using System.IO;
using Netcode.File.Archive.SharpZipLib.Core;

namespace Netcode.File.Archive.SharpZipLib.Zip
{
	/// <summary>
	...
	public class FastZip
	{
		...
		public void CreateZip(string zipFileName, string sourceDirectory, bool recurse, string fileFilter, string directoryFilter)
		{
            ...
            outputStream = new ZipOutputStream(System.IO.File.Create(zipFileName));
			try {
		                       ...
		                       string fileFilter, string directoryFilter)
		{
            ...
            inputStream = new ZipInputStream(System.IO.File.OpenRead(zipFileName));
		...
		void AddFileContents(string name)
		{
            ...
            FileStream stream = System.IO.File.OpenRead(name);
			try {
				int length;
				do {
		...
		void ExtractFileEntry(ZipEntry entry, string targetName)
		{
			bool proceed = true;
			if ((overwrite == Overwrite.Prompt) && (confirmDelegate != null)) {
                if (System.IO.File.Exists(targetName) == true)
                {
			...
			if ( proceed ) {
                ...
                FileStream streamWriter = System.IO.File.Create(targetName);
